...
a dict in python (\textit{phase\_center\_catalog}). The top level keys are strings
giving the phase center catalog names. The next level keys must include:
	\begin{itemize}
...
types of phase centers, the phase\_center\_app\_ra, phase\_center\_app\_dec,
phase\_center\_frame\_pa and phase\_center\_catalog were added and the
following header items were removed:

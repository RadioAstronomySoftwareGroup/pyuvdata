...
class UVData(UVBase):
    ...
    def read_ms(self, filepath, run_check=True,
        ...
        Args:
            filepath: The measurement set to read in
            run_check: Option to check for the existence and proper shapes of
                required parameters after reading in the file. Default is True.
            ...
            test_import_uvfits: specify whether you are running test on a .ms file generated by CASA's importuvfits function.
                                if true, ignores last five lines of history corresponding to import function (for purposes of testing)
        """

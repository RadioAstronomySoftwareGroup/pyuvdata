...
def test_spatial_interpolation_samepoints(
    ...
    if beam_type == "efield":
        np.testing.assert_allclose(interp_basis_vector, interp_basis_vector2)
...
def test_healpix_interpolation(
    ...
    za_orig_vals, az_orig_vals = uvutils.hpx_latlon_to_zenithangle_azimuth(
...
def test_find_healpix_indices(start, stop, phi_start, phi_end):
    ...
    hpx_za, hpx_az = uvutils.hpx_latlon_to_zenithangle_azimuth(hpx_lat.rad, hpx_lon.rad)

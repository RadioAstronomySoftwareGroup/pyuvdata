...
def test_old_phase_attributes_header(casa_uvfits, tmp_path):
    ...
    with check_warnings(UserWarning, match=["Fixing phases using antenna positions."]):
...
def test_write_uvh5_part_fix_autos(uv_uvh5, tmp_path):
    ...
    uv_uvh5.write_uvh5_part(
        testfile,
        data_array=uv_uvh5.data_array,
        flag_array=uv_uvh5.flag_array,
        nsample_array=uv_uvh5.nsample_array,
        fix_autos=True,
    )
